            ...
            <div className='card-body p-0 '>
              <div className='px-9 pt-7 card-rounded w-100 text-dark'>
                ...
                <div className='card-scroll h-300px fs-3 fw-semibold ps-1'>
                  <div className='p-2 fw-bold border-bottom fst-italic'>bc1ql5f3m75qx3ueu2pz5eeveyqsw6pdjs3ufk8r20</div>
            ...
            <div className='card-body p-0 '>
              <div className='px-9 pt-7 card-rounded h-275px w-100 bg-dark'>
                ...
                <div className='d-flex text-center flex-column  pt-8'>
                  ...
                  <span className='fw-bold fs-2x pt-1'>$1,070,653.46</span>
                </div>
              </div>
              <div
              ...
              >
                <div className='d-flex align-items-center mb-6'>
                  ...
                  <div className='d-flex align-items-center flex-wrap w-100'>
                    ...
                    <div className='d-flex align-items-center'>
                      <div className='fw-bold fs-5 text-gray-800 pe-1'>&#8361;1,389,708,186원</div>
                      <KTSVG
                ...
                <div className='d-flex align-items-center mb-6'>
                  ...
                  <div className='d-flex align-items-center flex-wrap w-100'>
                    ...
                    <div className='d-flex align-items-center '>
                      <div className='fw-bold fs-5 text-gray-800 pe-1'>$535,326.73 </div>
                      <KTSVG
                ...
                <div className='d-flex align-items-center'>
                  ...
                  <div className='d-flex align-items-center flex-wrap w-100'>
                    <div className='mb-1 pe-3 flex-grow-1'>
                      ...
                      <div className='text-gray-400 fw-semibold fs-7'>21.07.12</div>
                    </div>
                    <div className='d-flex align-items-center'>
                      <div className='fw-bold fs-5 text-gray-800 pe-1'>$1,037,560.53</div>
                      <KTSVG
                        path='/media/icons/duotune/arrows/arr066.svg'
                        className='svg-icon-5 svg-icon-success ms-1'
                      />
