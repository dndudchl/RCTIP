  ...
  return (
    <>
      <div className='d-flex flex-wrap flex-stack mb-7'>
        ...
        The VSOP ransomware gang is believed to be a new group, renamed ONYX Group 
        </h2>
      </div>

      <div className='mb-10 ms-1'>
        
        <div className='fw-normal fs-4'>onion_address: mrdxtxy6vqeqbmb4rvbvueh2kukb3e3mhu3wdothqn7242gztxyzycid.onion </div>
      ...
      <div className='row g-6 g-xl-9'>
        ...
        <div className='col-md-6 col-xxl-4'>
          <Card1
            name='jaspercountysheriffoffice'
            Region='US'
            Sector='public organization'
            date=''
          />
        </div>
        <div className='col-md-6 col-xxl-4'>
