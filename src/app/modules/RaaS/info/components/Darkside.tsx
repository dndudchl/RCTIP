            ...
            <div className='card-body p-0 '>
              <div className='px-9 pt-7 card-rounded w-100 text-dark'>
                ...
                <div className='card-scroll h-300px fs-3 fw-semibold ps-1'>
                  <div className='p-2 fw-bold border-bottom fst-italic'>bc1q7eqww9dmm9p48hx5yz5gcvmncu65w43wfytpsf</div>
				  <div className='p-2 fw-bold border-bottom fst-italic'>bc1qjhdw0582hu8sl2l56dyu9l4rk366hhu7j5xpgu</div>
				  <div className='p-2 fw-bold border-bottom fst-italic'>bc1qhq37atw5ldcppf2fd0fsmsmejxkvp2qfy472pq</div>
            ...
            <div className='card-body p-0 '>
              <div className='px-9 pt-7 card-rounded h-275px w-100 bg-dark'>
                ...
                <div className='d-flex text-center flex-column  pt-8'>
                  ...
                  <span className='fw-bold fs-2x pt-1'>$9,124,090.7</span>
                </div>
              </div>
              <div
              ...
              >
                <div className='d-flex align-items-center mb-6'>
                  ...
                  <div className='d-flex align-items-center flex-wrap w-100'>
                    ...
                    <div className='d-flex align-items-center'>
                      <div className='fw-bold fs-5 text-gray-800 pe-1'>&#8361;11,843,069,732원</div>
                      <KTSVG
                ...
                <div className='d-flex align-items-center mb-6'>
                  ...
                  <div className='d-flex align-items-center flex-wrap w-100'>
                    ...
                    <div className='d-flex align-items-center'>
                      <div className='fw-bold fs-5 text-gray-800 pe-1'>4</div>
                      <KTSVG
                ...
                <div className='d-flex align-items-center mb-6'>
                  ...
                  <div className='d-flex align-items-center flex-wrap w-100'>
                    ...
                    <div className='d-flex align-items-center '>
                      <div className='fw-bold fs-5 text-gray-800 pe-1'>$2,281,022.68 </div>
                      <KTSVG
                ...
                <div className='d-flex align-items-center'>
                  ...
                  <div className='d-flex align-items-center flex-wrap w-100'>
                    <div className='mb-1 pe-3 flex-grow-1'>
                      ...
                      <div className='text-gray-400 fw-semibold fs-7'>21.05.12</div>
                    </div>
                    <div className='d-flex align-items-center'>
                      <div className='fw-bold fs-5 text-gray-800 pe-1'>$4,453,920.7</div>
                      <KTSVG
                        path='/media/icons/duotune/arrows/arr066.svg'
                        className='svg-icon-5 svg-icon-success ms-1'
                      />
