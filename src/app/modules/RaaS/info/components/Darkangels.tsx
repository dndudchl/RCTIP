...
const Darkangels: FC = () => {
  return (
    <>
      <div className='mb-12'>
        <h1 className='text-danger lh-xxl fw-bolder my-2 fs-2qx '>Darkangels</h1>
        <h2 className='fs-3 fw-light ms-2 me-20 fst-italic'>A new ransomware malware dubbed DarkAngels by Cyble Research Labs has been identified. There are similarities between the DarkAngels malware and the Babuk ransomware as uncovered during an analytical analysis of the malware.</h2>
      </div>
            ...
            <div className='card-body p-0 '>
              <div className='px-9 pt-7 card-rounded w-100 text-dark'>
                ...
                <div className='card-scroll h-300px fs-3 fw-semibold ps-1'>
                  <div className='p-2 fw-bold border-bottom fst-italic'>bc1q0wf73xmcqkvrvs7tj49hznxqqgt6tp359gk0az</div>
