  ...
  return (
    <>
      <div className='d-flex flex-wrap flex-stack mb-7'>
        ...
        Redalert ransomware is a multi-platform ransomware that runs on Windows and Linux. RDP vulnerabilities are presumed to be the main route of infection
        </h2>
      </div>

      <div className='mb-10 ms-1'>
        
        <div className='fw-normal fs-4'>onion_address: blog2hkbm6gogpv2b3uytzi3bj5d5zmc4asbybumjkhuqhas355janyd.onion </div>
