            ...
            <tbody>
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Remote Desktop Protocol</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Remote Access Software</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-gray-100 fs-8 fw-bold me-2'>T1573</span>
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Encrypted Channel</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-gray-100 fs-8 fw-bold me-2'>T1531</span>
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Account Access Removal</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Command and Scripting Interpreter: Windows Command Shelll</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Command and Scripting Interpreter: Windows Command Shelll</span>
					</div>
				</div>
				<div className='card-body pt-3'>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Remote Desktop Protocol</span>
					</div>
				</div>
				<div className='card-body pt-3'>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Remote Access Software</span>
					</div>
				</div>
				<div className='card-body pt-3'>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-gray-100 fs-5 fw-bold me-1'>T1573</span>
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Encrypted Channel</span>
					</div>
				</div>
				<div className='card-body pt-3'>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-gray-100 fs-5 fw-bold me-1'>T1531</span>
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Account Access Removal</span>
					</div>
				</div>
				<div className='card-body pt-3'>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					...
					<div className='fs-4 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>.(random string)</div>
