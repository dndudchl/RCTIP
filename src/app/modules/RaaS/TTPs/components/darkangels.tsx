...
const DarkAngels: React.FC<Propx> = ({className}) => { 
  return (
	<>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>The cybercriminals obtained a first footprint in the victim's perimeter using malspam.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>After execution, DarkAngels Ransomware tries to get system information using GetSystemInfo() API, which extracts information such as NumberOfProcessors</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>They scanned the network in order to obtain access to older machines.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>The malware deletes shadow copies to avoid recovery of the system after encrypting the files.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>The ransomware then checks the presence of the services such as VSS, SQL, Memtas, etc., and terminates them if the services are actively running on the victim's machine. The ransomware also enumerates the running processes using CreateToolhelp32Snapshot(), Process32FirstW(), and Process32NextW() APIs, checks the process names such as sql.exe,oracle.exe, powerpnt.exe, etc., and terminates them if they are actively running.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>The ransomware also excludes file extensions such as .exe, .dll, and .babyk. The .babyk is a well-known extension for Babuk ransomware which indicates the DarkAngels is linked to Babuk ransomware. Like Babuk ransomware, the DarkAngels appends a signature “choung dong looks like hot dog”  at the end of the encrypted file.</div>
