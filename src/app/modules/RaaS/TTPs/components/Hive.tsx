          ...
          <table className='table align-baseline gx-1 gy-4 table-striped border border-dark'>
            <thead>
              <tr className='fs-6 fw-semebold text-white bg-dark text-center'>
               <th className='border-start border-dark min-w-175px mw-185px'>Initial-Access</th>
               <th className='border min-w-175px'>Execution</th>
               <th className='border min-w-175px'>Persistence</th>
               <th className='border min-w-175px'>Privilege-Escalation</th>
               <th className='border min-w-175px'>Defense-Evasion</th>
               <th className='border min-w-175px'>Credential-Access</th>
               <th className='border min-w-175px'>Discovery</th>
               <th className='border min-w-175px'>Lateral-Movement</th>
               <th className='border min-w-175px'>Command-and-Control</th>
               <th className='border-end border-dark min-w-175px'>Impact</th>
              </tr>
            </thead>
            <tbody>
							<tr className=''>              
