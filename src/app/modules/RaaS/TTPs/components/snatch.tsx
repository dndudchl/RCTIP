...
const Snatch: React.FC<Propx> = ({className}) => { 
  return (
	<>
				...
				<tr className=''>				
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-white fs-8 fw-bold me-2'>T1078.002</span>
								<span className='text-dark fw-semibold mb-1 fs-7'>Valid Accounts: Domain Accounts</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>By Brute Forcing, Find out Domain administrator of the RDP</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Deploying a tool set in C:\Windows</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Adding registry to establish persistence</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Performed a simple arp -a</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Begin lateral movement initiating an RDP session</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-white fs-8 fw-bold me-2'>T1119</span>
								<span className='text-dark fw-semibold mb-1 fs-7'>Automated Collection</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Runs Update_Collector.exe</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Stop the SuperBackupMan service and delete volume shadow copies</div>
								</div>
							</div>
						</div>
					</td>          
				...
				<tr className=''>				
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Creates a hidden service that accessed over the Tor network.</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							...
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Starts up the Windows with safe mode</div>
								</div>
							</div>
						</div>
					</td>          
					...
					<td className='align-items-baseline border-start border-end border-dark'>
						<div className='px-2 d-flex flex-column'>
							<div className='symbol symbol-50px pb-1'>
								<span className='badge badge-dark text-white fs-8 fw-bold me-2'>1486</span>
								<span className='text-dark fw-semibold mb-1 fs-7'>Data Encrypted for Impact</span>
							</div>
							<div className='bg-gray-500 border-start border-danger1 border-3 ps-4 pt-2 pb-1 pe-1 fst-italic'>
								<div className='text-white fw-semibold d-block fs-7'>
									<div>Encrypt files with AES-256</div>
								</div>
							</div>
						</div>
					</td>          
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-white fs-5 fw-bold me-1'>T1078.002</span>
						<span className='text-dark fw-bold mb-1 fs-3'>- Valid Accounts: Domain Accounts</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Find out the Domain Administrator (DA) of the RDP through Brute Force and log in.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Once on the DC the threat actor moved quickly deploying a tool set in C:\Windows. This tool set included 2 executable that masqueraded as Windows Management Instrumentation files.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-dark fst-italic'>
							<div>&deg;&nbsp;C:\Windows\wmis\WmiPrivSystemsES.exe —nt-service -f C:\Windows\wmis\libeay32.dat</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Snatch establish persistence and executes the ransomware at system startup by adding the following registry entry.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Creates a hidden service (Onion service) that can be accessed over the Tor network. To continue running the Tor client, an attacker runs the service.bat script to run the service. The Service Control (sc.exe) command-line utility was used in this script.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Disable AV products using tools(Process Hacker, I0bit Uninstaller, PowerTool, PsExec).</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Snatch may abuse Windows safe mode to disable endpoint defenses. Safe mode starts up the Windows operating system with a limited set of drivers and services.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-dark fst-italic'>
							<div>&deg;&nbsp;bcdedit /set current safeboot minimal</div>
							<div>&deg;&nbsp;shutdown /r /f /t 00</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Initially with that access they performed a simple arp -a.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>The threat actors made the next move running ipconfig and quser. Just minutes later they began lateral movement initiating an RDP session with a DC.</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-white fs-5 fw-bold me-1'>T1119</span>
						<span className='text-dark fw-bold mb-1 fs-3'>- Automated Collection</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Runs Update_Collector.exe, a program that is believed to have been created by itself. The program uses WMI to investigate other systems and user accounts on the network, dump the information to a file, and upload it to the C&C server.</div>
					...
					<div className='mb-5'>
						...
						<div className='fs-5 fw-semibold mt-2 mb-2 ms-5 text-dark fst-italic'>
							<div>&deg;&nbsp;mkdir %temp%\T1119_command_prompt_collection nul 2&1</div>
							<div>&deg;&nbsp;dir c: /b /s .docx | findstr /e .docx</div>
							<div>&deg;&nbsp;for /R c: %f in (*.docx) do copy %f %temp%\T1119_command_prompt_collection</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>They did was create a reverse shell using what we think is Meterpreter. C2 initiated over HTTPS/443 to 91.229.77.161 via cplXen.exe</div>
	...
	<div className='row g-5 g-xl-8 pt-4'>
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				...
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>After the infected machine reboots into Safe Mode, Snatch stop the SuperBackupMan service and delete the volume shadow copies. Encryption process is next.</div>
		...
		<div className='col-xl-6'>
			<div className='card card-xl-stretch mb-xl-8'>
				<div className='card-header align-items-center border-0 mt-4'>
					<div className='symbol symbol-50px pb-1'>
						<span className='badge badge-dark text-white fs-5 fw-bold me-1'>1486</span>
						<span className='text-dark fw-bold mb-1 fs-3'>- Data Encrypted for Impact</span>
					</div>
				</div>
				<div className='card-body pt-3'>
					<div className='text-gray-700 fs-4 mb-7 fst-italic'>Snatch ransomware encrypts the files it can reach with the AES-256 encryption. That cipher is widely used by different ransomware groups, sometimes even in the combination with other encryption algorithms - RSA-2048, for example.</div>
					...
					<div className='fs-4 fw-semibold mt-2 mb-2 ms-5 text-dark fst-italic'>.snatch</div>
