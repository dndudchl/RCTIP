...
const Redalert: React.FC<Props> = ({className}) => {
  return (
          ...
          <table className='table table-row-bordered table-row-gray-200 align-middle gs-0 gy-3'>
            ...
            <tbody>
							<tr>
								...
								<td><div className='text-dark fw-bold d-block mb-1 fs-6'>da6a7e9d39f6a9c802bbd1ce60909de2b6e2a2aa</div></td>
								<td>
									<div className='text-dark fw-bold d-block mb-1 fs-6'>
										...
										<span className='badge badge-light-info me-2 mb-1'>redalert</span>
							...
							<tr>
								...
								<td><div className='text-dark fw-bold fs-6'>File hash</div></td>
								<td><div className='text-dark fw-bold d-block mb-1 fs-6'>f2fa9a3ce883a7f5b43ba5c9ff7bdf75</div></td>
								<td>
									<div className='text-dark fw-bold d-block mb-1 fs-6'>
							...
							<tr>
								...
								<td><div className='text-dark fw-bold fs-6'>File hash</div></td>
								<td><div className='text-dark fw-bold d-block mb-1 fs-6'>039e1765de1cdec65ad5e49266ab794f8e5642adb0bdeb78d8c0b77e8b34ae09</div></td>
								<td>
									<div className='text-dark fw-bold d-block mb-1 fs-6'>
										<span className='badge badge-light-info me-2 mb-1'>esxi</span>
										<span className='badge badge-light-info me-2 mb-1'>ransomware</span>
